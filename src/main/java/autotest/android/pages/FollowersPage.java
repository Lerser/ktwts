 ...
 */
public class FollowersPage extends MobileBasePage {
    ...
    private static final String SUBSCRIBER_BY_NUMBER = "//android.support.v7.widget.RecyclerView[@resource-id='com.mgrmobi.intouch:id/id_recycler_view']/" +
            "android.view.View[@index='%d']/android.widget.ImageView[@resource-id='com.mgrmobi.intouch:id/drawee_avatar']";
    private static final String SUBSCRIBER_NICK_BY_NUMBER = "//android.support.v7.widget.RecyclerView[@resource-id='com.mgrmobi.intouch:id/id_recycler_view']/" +
            "android.view.View[@index='%d']/android.widget.TextView[@resource-id='com.mgrmobi.intouch:id/text_user_nickname']";
    private static final String SUBSCRIBE_BY_NUMBER = "//android.support.v7.widget.RecyclerView[@resource-id='com.mgrmobi.intouch:id/id_recycler_view']/" +
            "android.view.View[@index='%d']/android.widget.ImageButton[@resource-id='com.mgrmobi.intouch:id/button_connect_user']";
    ...
    public FollowersPage search(String searchQuery) {
    ...
    public FollowersPage subscribeByNumber(int number) {
...
//    TODO: Доделать получение данных со списка сабов
    ...
    public FeedPage openEventByNumber(int number) {
