...
//    @Step("{2}")
//    steps4allure
    static public void assertTrue(boolean condition, String message, String whatCheck) {
        if (!condition) {
     ...
     */
//    @Step("{2}")
    static public void assertFalse(boolean condition, String message, String whatCheck) {
        if (condition) {
            failNotEquals(Boolean.valueOf(condition), Boolean.FALSE, message); // TESTNG-81
        }
    }
     ...
     */
//    @Step("{3}")
    static public void assertEquals(Object actual, Object expected, String message, String whatCheck) {
        if ((expected == null) && (actual == null)) {
            fail("Оба объекта равны null");
        }
        if (expected != null) {
...
//    @Step("{3}")
    static public <T> void assertInArray(T expected, Collection<? super T> actual, String message, String whatCheck) {
        if ((expected == null) && (actual == null)) {
            fail("Оба объекта равны null");
        }
        if (expected != null) {
    ...
    static private void failNotContains(Object actual, Object expected, String message) {
        fail(formatContains(actual, expected, message));
    }
    ...
    static String formatContains(Object actual, Object expected, String message) {
        String formatted = "";
        if (null != message) {
            formatted = "\"" + message + "\"" + " ";
        }

        return formatted + EclipseInterface.ASSERT_LEFT_CONTAINS + actual + EclipseInterface.ASSERT_MIDDLE_CONTAINS + expected + EclipseInterface.ASSERT_RIGHT;
    }
